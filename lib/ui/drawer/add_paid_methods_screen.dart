...
class AddPaidMethodsScreen extends StatelessWidget {
  const AddPaidMethodsScreen({super.key});
            ...
            Container(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Text(
                    'Por favor, añade los datos de tu tarjeta',
                    style: MyTheme.basicTextStyle(
                        size: 16,
                        fontWeight: FontWeight.normal,
                        color: MyTheme.ocreOscuro),
                  ...
                  Image.asset('assets/images/Paymentbycreditcard.png'),
                  SizedBox(
                    height: 2.h,
                  ),
                  GetBuilder(
